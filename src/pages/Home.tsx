...
function Home() {
  return (
    <>
      ...
      <div className='relative flex flex-col flex-grow w-full h-screen overflow-hidden z-1'>
        <div className='sticky top-0 z-10'>
          <Navbar />
        </div>
        {/* Content */}
        <div className='flex p-10 items-center justify-center flex-grow'>
        ...
        <div className='sticky bottom-0 left-0 right-0 w-full z-1'>
          <Footer />
        </div>
      </div>
    </>
